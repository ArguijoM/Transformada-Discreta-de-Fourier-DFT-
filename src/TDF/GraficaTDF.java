 ...
 * @author hacu
 */
public class GraficaTDF {
    private double N1;//intervalo
    private double N2;//intervalo
    private Complejo[] C;//coeficiente de la función
    private double[] D;
    ...
    public GraficaTDF(Complejo[] c, int n1, int n2){
        this.N1=n1;
        this.N2=n2;
        this.C=c;
        ...
        //Generar Ventana
        JFrame frame =  new JFrame("Grafica de frecuencia");
        ...
        @Override
            public void actionPerformed(ActionEvent ae) {
                ...
                for(int i=0;i<C.length;i++){               
                    ...
                    arrayYk = new double[]{i,C[i].getImaginario()};
                    plot.addLinePlot("Funcion",Color.BLUE,arrayXk, arrayYk); 
                    plot.addScatterPlot("Funcion",Color.BLUE,arrayXk, arrayYk);
                }
    ...
    private JPanel contruirPanelSur(){
        ...
        funcion.setBackground(Color.BLUE);
        pSur.add(new JLabel("Serie de Fourier: "));
        pSur.add(funcion);
